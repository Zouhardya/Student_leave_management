        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    <li>&nbsp;</li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="index.php"><span class="card-title" style="font-size:20px;">Student Login</span></a></li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><span class="card-title" style="font-size:20px;">Pass Recovery (S)</span></a></li>
                
                       <li class="no-padding"><a class="waves-effect waves-grey" href="admin/"><span class="card-title" style="font-size:20px;">Admin Login</span></a></li>
